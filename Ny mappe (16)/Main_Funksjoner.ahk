...
LagreNyeHurtigtaster(g, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11) {
    ...
    ; "$"-prefiks tvinger hook-basert registrering (se forklaring ved oppstart
    ; i Main.ahk) slik at enkle taster som F11 ikke tapes stille til andre
    ; programmer som har reservert samme tast via Windows' RegisterHotkey-API.
    feilet := ""
