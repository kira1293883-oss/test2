...
; "$"-prefiks tvinger AHK til å bruke tastatur-HOOK i stedet for Windows'
; eksklusive RegisterHotkey-API. Uten dette kan enkle taster som F11 tapes
; stille til et annet program (f.eks. en skjermopptaker) som har reservert
; nøyaktig samme tast — AHK ville da ikke fått noen feilmelding, bare aldri
; mottatt tastetrykket.
...
try {
    MsgBox("🤖 MODULÆRT DELUXE SYSTEM STARTET!`n`n🚀 TURBO 0MS AKTIVERT SOM STANDARD!`n`nF1: Knapper | F3: Pakk ut | F5: Auto-Close | F7: Fart | F9: Passordregister | F10: Tema", "System", 64)
}
