...
LagreNyeHurtigtaster(g, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11) {
    ...
    ; "$"-prefiks tvinger hook-basert registrering slik at enkle taster som
    ; F11 ikke tapes stille til andre programmer (f.eks. skjermopptakere) som
    ; har reservert samme tast via Windows' RegisterHotkey-API.
    feilet := ""
