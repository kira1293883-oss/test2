...
# test2#Requires AutoHotkey v2.0
...
F5_SlettFilBekreft(*) {
    ...
    try {
        ...
        if (HasFunc("ShowL"))
            ShowL()
        SoundPlay("*16")
        ToolTip("Fil slettet og økt nullstilt!")
...
; ==============================================================================
OnClipboardChange(CatchClip)
SetTimer(() => UpdStl(false), 400)
SetTimer(SjekkKlikkUtenfor, 200)

; Last inn lagrede passord sikkert i bakgrunnen uten å låse grensesnittet ved oppstart
SetTimer(LastInnLagredePassordSikkert, -500)
...
try {
    MsgBox("🤖 MODULÆRT DELUXE SYSTEM STARTET!`n`n🚀 TURBO 0MS AKTIVERT SOM STANDARD!`n`nF1: Knapper | F5: Auto-Close | F6: Passord | F7: Fart | F10: Tema", "System", 64)
}
...
; ==============================================================================
F5:: {
    global GullModus, sysGui, AutoClose_F1, AutoClose_F7, cbF1, cbF7, SrcM, LogF, SessionFile
    global btnResetFile, btnResetFileYes, btnResetFileNo
    try {
        ...
        ; Modus-bryter (Auto-Fangst)
        sysGui.SetFont("s9 Bold")
        btnState := sysGui.Add("Button", "w320 h38 xm y+12 -Theme " (GullModus ? "+Background155724 cWhite" : "+Background444444 cAAAAAA"), GullModus ? "⚡ Auto-Fangst: PÅ" : "⚡ Auto-Fangst: AV")
        btnState.OnEvent("Click", (b,*)=>(GullModus:=!GullModus, SoundPlay(GullModus ? "*64" : "*48"), b.Opt(GullModus ? "+Background155724 cWhite" : "+Background444444 cAAAAAA"), b.Text := (GullModus ? "⚡ Auto-Fangst: PÅ" : "⚡ Auto-Fangst: AV")))
